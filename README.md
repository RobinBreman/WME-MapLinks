...
Edit code in the `/src` folder, update version nr in `/package.json` , `src\wme-maplinks.ts`, `src\wme-maplinks.meta.ts` then
...
After build .js files are copied to the root folder, for distribution to greasyfork

## Changelog
|Version||
|---|---|
1.4.3 | Changed WS3 link
1.4.2 | Fixed Overlapping with WME mapcounter
